...
- (void)testFilledSquareInset
{
	...
	element = [result elementAtIndex:1 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(105.522847, -10.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(110.000000, -5.522847)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(110.000000, 0.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:2 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(110.000000, 100.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:3 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(110.000000, 105.522847)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(105.522847, 110.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(100.000000, 110.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:4 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(0.000000, 110.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:5 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(-5.522847, 110.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(-10.000000, 105.522847)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(-10.000000, 100.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:6 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(-10.000000, 0.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:7 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(-10.000000, -5.522847)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(-5.522847, -10.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(0.000000, -10.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:8 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(100.000000, -10.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
}

- (void)testOpenSquareInset
{
	NSBezierPathElement element;
	CGPoint points[3];
	NSBezierPath * a;
	...
	result = [a WFInsetPath:5.0];
	XCTAssertTrue( [result elementCount] == 14, @"Incorrect element count" );
	element = [result elementAtIndex:0 associatedPoints:points];
	XCTAssertTrue( element == NSMoveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(95.000000, 5.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:1 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(95.000000, 95.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:2 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(5.000000, 95.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:3 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(5.000000, 5.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:4 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(95.000000, 5.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:5 associatedPoints:points];
	XCTAssertTrue( element == NSMoveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(15.000000, 80.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:6 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(15.000000, 82.761424)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(17.238576, 85.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(20.000000, 85.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:7 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(80.000000, 85.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:8 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(82.761424, 85.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(85.000000, 82.761424)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(85.000000, 80.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:9 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(85.000000, 20.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:10 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(85.000000, 17.238576)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(82.761424, 15.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(80.000000, 15.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:11 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(20.000000, 15.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:12 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(17.238576, 15.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(15.000000, 17.238576)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(15.000000, 20.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:13 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(15.000000, 80.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	...
	element = [result elementAtIndex:0 associatedPoints:points];
	XCTAssertTrue( element == NSMoveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(100.000000, -5.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:1 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(102.761424, -5.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(105.000000, -2.761424)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(105.000000, 0.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:2 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(105.000000, 100.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:3 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(105.000000, 102.761424)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(102.761424, 105.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(100.000000, 105.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:4 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(0.000000, 105.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:5 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(-2.761424, 105.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(-5.000000, 102.761424)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(-5.000000, 100.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:6 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(-5.000000, 0.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:7 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(-5.000000, -2.761424)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(-2.761424, -5.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(0.000000, -5.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:8 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(100.000000, -5.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:9 associatedPoints:points];
	XCTAssertTrue( element == NSMoveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(25.000000, 75.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:10 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(75.000000, 75.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:11 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(75.000000, 25.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:12 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(25.000000, 25.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:13 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(25.000000, 75.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
}

- (void)testOpenSquareDissapearingInset
{
	NSBezierPathElement element;
	CGPoint points[3];
	NSBezierPath * a;
	...
	element = [result elementAtIndex:1 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(116.568542, -30.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(130.000000, -16.568542)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(130.000000, 0.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:2 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(130.000000, 100.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:3 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(130.000000, 116.568542)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(116.568542, 130.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(100.000000, 130.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:4 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(0.000000, 130.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:5 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(-16.568542, 130.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(-30.000000, 116.568542)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(-30.000000, 100.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:6 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(-30.000000, 0.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:7 associatedPoints:points];
	XCTAssertTrue( element == NSCurveToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(-30.000000, -16.568542)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[1], CGPointMake(-16.568542, -30.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	XCTAssertTrue( WFGeometryDistance(points[2], CGPointMake(0.000000, -30.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
	element = [result elementAtIndex:8 associatedPoints:points];
	XCTAssertTrue( element == NSLineToBezierPathElement, @"Incorrect element" );
	XCTAssertTrue( WFGeometryDistance(points[0], CGPointMake(100.000000, -30.000000)) <= WFBezierPointAcceptanceResolution, @"Incorrect result point" );
}
